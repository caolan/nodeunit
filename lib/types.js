...
var assertWrapper = function (callback) {
  return function (new_method, assert_method) {
    return function () {
      var message, a, actual, expected, multiline, spacing;
      ...
      try {
        ...
        if (Object.getOwnPropertyDescriptor(e, 'actual') &&
          ...
          actual = sys.inspect(e.actual).replace(/\n$/, '');
          expected = sys.inspect(e.expected).replace(/\n$/, '');
          multiline = (
            actual.indexOf('\n') !== -1 ||
            expected.indexOf('\n') !== -1
          );
...
exports.test = function (name, start, options, callback) {
  var
    expecting,
    a_list = [],
    wrapAssert = assertWrapper(function (a) {
      a_list.push(a);
    ...
    test = {
        ...
        if (expecting !== undefined && expecting !== a_list.length) {
          ...
          a1 = exports.assertion({method: 'expect', error: e});
          a_list.push(a1);
          process.nextTick(function () {
            options.log(a1);
          });
        ...
        if (err) {
          a2 = exports.assertion({error: err});
          a_list.push(a2);
          process.nextTick(function () {
            options.log(a2);
          });
