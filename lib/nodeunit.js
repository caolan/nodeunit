    ...
    return {
            ...
            process.nextTick(function(){
                options.testDone({
                    ...
                    passed: function(){return !failures;},
                    failed: function(){return Boolean(failures);},
                    name: options.name
                });
            });
        },
            ...
            testDone: function(test){
                ...
                if(i < tests.length){
                    ...
                    (options.moduleDone || function(){})({
                        ...
                        name: options.name,
                        tests: test_results,
                        passed: function(){return !m_failures;},
                        failed: function(){return Boolean(m_failures);}
                    });
                }
            }
        });
...
exports.runFiles = function(paths, options){
    ...
    if(!paths.length) return options.done({
        failures: 0,
        total: 0,
        modules: []
    });
