...
exports.testBeforeAllDeepNested = function (test) {
    ...
    nodeunit.runSuite(null, suite, {}, function (err, assertions) {
        ...
        test.equal(childAfterAllCount, 1);
        test.equal(val3, 'flah-afterall-parent');
        test.equal(val2, 'flah-afterall-child');
